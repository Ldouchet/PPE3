 ...
 */
public class DetailJoueurActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Joueur leJoueur =  MatchingActivity.le_match.getC2().getLesTitulaires().get(position);
        ...
        jaune.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                carton.setTemps(DetailJoueurActivity2.temps_actuel);
                MatchingActivity.le_match.ajouterCarton(carton);
                DetailJoueurActivity2.this.finish();
        ...
        but.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                but.setTemps(DetailJoueurActivity2.temps_actuel);
                MatchingActivity.le_match.ajouterBut2(but);
                DetailJoueurActivity2.this.finish();
