...
public class Match {
    ...
    public void preparerMatch(String codeMatch){
        ...
        this.c1 = new Club (1,"Loïc");
        this.c2 = new Club (2,"Guy");

        Joueur J1C1 = new Joueur(1,"Stan","Smith",true);
        Joueur J2C1 = new Joueur(2,"Francine","Smith",true);
        Joueur J3C1 = new Joueur(3,"Hayley","Smith",true);
        Joueur J4C1 = new Joueur(4,"Steve","Smith",false);
        Joueur J5C1 = new Joueur(5,"Roger","Smith",false);
        ...
        Joueur J2C2 = new Joueur(7,"Kyle","Broflovski",true);
        Joueur J3C2 = new Joueur(8,"Stan","Marsh",true);
        Joueur J4C2 = new Joueur(9,"Kenny","McCormick",true);
        Joueur J5C2 = new Joueur(10,"Butters","Stotch",false);
